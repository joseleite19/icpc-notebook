...
\includes{Berlekamp Massey}{code/math/berlekamp_massey.cpp}
\includes{Multipoint Evaluation}{code/math/multipoint_evaluation.cpp}
...
\includes{K-Shortest Path}{code/misc/k_shortest_path.cpp}
\includes{Directed MST}{code/misc/directed_mst.cpp}
\includes{Convex Layers}{code/misc/convex_layers.cpp}
