...
\includes{Template}{code/template.cpp}
...
\includes{Segtree Beats}{code/ed/seg_beats.cpp}
\includes{KD Tree}{code/ed/kd_tree.cpp}
...
\includes{mjhum's flow}{code/graph/mjhum_flow.cpp}
...
\includes{Delaunay}{code/geometry/delaynay.cpp}
\includes{Simple Triangulate}{code/geometry/triangulate.cpp}
